...
export function AdminDashboard() {
  const { staffUsers, tables, promoCodes, announcements, closedDates, rates, tattooArtists, reservations, feedback } = useAppContext();
  ...
  const cards = [
    ...
    { label: 'Tattoo Artists',    value: activeArtists,     total: tattooArtists.length,    color: 'text-pink-400',    bg: 'bg-pink-500/10',    border: 'border-pink-500/20',    icon: Activity,     link: '/admin/tattoo-artists' },
  ];
